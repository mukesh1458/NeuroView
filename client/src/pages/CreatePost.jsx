  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto animate-fade-in-up">
        ...
        <div className='mb-6'>
          <h1 className="heading-hero text-[32px] sm:text-[48px] leading-[0.9]">Create Content</h1>
          <p className="mt-2 text-zinc-400 text-[16px] max-w-[600px] leading-relaxed font-light">
            Generate imaginative and visually stunning images through DALL-E AI and share them with the community.
          </p>
        </div>
        ...
        <form className='mt-10 max-w-3xl' onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className='flex items-center gap-2 mb-2'>
              <p className="block text-lg font-medium text-gray-300">Choose Model:</p>
              <CreatePageDropDown data={models} handleChange={handleChange} form={form} setForm={setForm} />
            </div>
            {/* Info About Models */}
            {/* Info About Models */}
            <div className='flex flex-col glass-panel p-6 gap-3 rounded-xl mt-4'>
              <h1 className='font-bold text-lg text-white flex items-center gap-2'>
                <span className="w-1 h-6 bg-blue-500 rounded-full"></span>
                Note:
              </h1>
              <div className='flex flex-col lg:flex-row gap-4'>
                <div className='flex-1 border border-white/10 bg-white/5 p-4 rounded-lg'>
                  <h2 className='font-semibold text-white mb-1'>stable-diffusion-2-1</h2>
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    This is a lighter model, hence generates output comparatively faster but compromises on quality of the image.
                  </p>
                </div>
                <div className='flex-1 border border-white/10 bg-white/5 p-4 rounded-lg'>
                  <h2 className='font-semibold text-white mb-1'>sdxl-wrong-lora</h2>
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    This is a heavier model, which improves output image quality but takes a bit more time.
